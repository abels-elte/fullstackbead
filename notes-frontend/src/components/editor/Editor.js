    ...
    return (
        <div className="edit-area">
            <div className="toolbar">
                <EditableName name={noteTitle} onChange={setNoteTitle}/>
                <Button icon="fa-solid fa-save" text="save note" onClick={saveNote}/>
                <Button icon="fa-solid fa-folder" text="choose folder"/>
            </div>  
            <EditableNote content={noteContent} onChange={setNoteContent}/>
        </div>
    );
}
